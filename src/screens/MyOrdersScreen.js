			...
			<TouchableOpacity 
				...
				<View style={styles.headerRow}>
					<View style={styles.statusContainer}>
						<Icon name="schedule" size={20} color={statusColor} />
		...
		<SafeAreaView style={styles.container}>
			...
			{appointments.length === 0 ? (
				<View style={styles.emptyContainer}>
					<Icon name="receipt-long" size={80} color={colors.grey3} />
					<Text style={styles.emptyTitle}>Chưa có đơn hàng nào</Text>
					<Text style={styles.emptySubtitle}>Hãy đặt món hoặc đặt phòng ngay!</Text>
				</View>
			) : (
				<FlatList
					data={appointments}
